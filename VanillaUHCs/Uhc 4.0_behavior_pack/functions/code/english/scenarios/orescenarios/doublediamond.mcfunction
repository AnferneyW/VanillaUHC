...
execute @s[tag=mainhost,scores={limitations=1}] ~ ~ ~ execute @a[tag=playing,scores={detect_diamond=1,diamond_limit=0..14}] ~ ~ ~ execute @e[type=item,name="Diamond"] ~ ~ ~ clone 1 -64 -1 1 -64 -1 ~ ~ ~
