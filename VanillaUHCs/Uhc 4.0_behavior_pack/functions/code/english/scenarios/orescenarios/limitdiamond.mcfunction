...
execute @s[tag=mainhost,scores={limitations=0}] ~ ~ ~ execute @a[tag=playing,scores={detect_diamond=1}] ~ ~ ~ execute @e[type=item,name="Diamond"] ~ ~ ~ clone 1 -64 -1 1 -64 -1 ~ ~ ~
execute @s[tag=mainhost,scores={limitations=1}] ~ ~ ~ execute @a[tag=playing,scores={detect_diamond=1,diamond_limit=0..15}] ~ ~ ~ execute @e[type=item,name="Diamond"] ~ ~ ~ clone 1 -64 -1 1 -64 -1 ~ ~ ~
...
execute @a[tag=playing,scores={detect_diamond=1}] ~ ~ ~ tellraw @a[tag=vanished] {"rawtext":[{"translate":"spectate.notification.ore","with":{"rawtext":[{"selector":"@s"},{"text":"1 Diamond"}]}}]}
