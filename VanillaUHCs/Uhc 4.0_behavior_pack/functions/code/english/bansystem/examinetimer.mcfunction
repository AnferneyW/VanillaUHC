execute @s[scores={menutimer=0}] ~ ~ ~ scoreboard objectives setdisplay below_name iron_limit
...
execute @s[scores={menutimer=2}] ~ ~ ~ scoreboard objectives setdisplay below_name gold_limit
execute @s[scores={menutimer=2}] ~ ~ ~ tellraw @a[tag=banmenu] {"rawtext":[{"translate":"ore.examination", "with":["§eGold"]}]}
execute @s[scores={menutimer=4}] ~ ~ ~ scoreboard objectives setdisplay below_name diamond_limit
execute @s[scores={menutimer=4}] ~ ~ ~ tellraw @a[tag=banmenu] {"rawtext":[{"translate":"ore.examination", "with":["§bDiamond"]}]}
execute @s[scores={menutimer=5}] ~ ~ ~ scoreboard objectives setdisplay below_name kills
