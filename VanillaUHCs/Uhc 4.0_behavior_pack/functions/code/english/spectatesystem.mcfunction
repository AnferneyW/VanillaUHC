...
#freezing
execute @s[tag=mainhost] ~ ~ ~ execute @e[type=item,name=§bFreeze] ~ ~ ~ execute @p[tag=playing,tag=!freeze,r=10] ~ ~ ~ function code/freeze
execute @s[tag=mainhost] ~ ~ ~ kill @e[type=item,name=§bFreeze]
execute @e[type=hovertext:marker,name=freeze] ~ ~ ~ tp @p[tag=freeze,r=5] @e[type=hovertext:marker,name=freeze,r=1]
#unfreezing
execute @s[tag=mainhost] ~ ~ ~ execute @e[type=item,name=§4Unfreeze,r=2] ~ ~ ~ execute @p[tag=freeze,r=10] ~ ~ ~ function code/unfreeze
#banmenu
...
#clearlag
execute @s[tag=mainhost] ~ ~ ~ execute @e[type=item,name="§eClearlag",r=2] ~ ~ ~ tag @p[tag=mainhost] add clearlag
