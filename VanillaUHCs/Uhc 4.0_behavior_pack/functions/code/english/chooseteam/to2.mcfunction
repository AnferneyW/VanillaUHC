...
execute @a[tag=!team,tag=!joinprocessteam14,scores={teamspaceleft=1..}] ~ ~ ~ execute @e[type=hovertext:hovertext,name="§eTeam 14",r=1] ~ ~ ~ tag @p add joinprocessteam14
execute @a[tag=!team,tag=!joinprocessteam15,scores={teamspaceleft=1..}] ~ ~ ~ execute @e[type=hovertext:hovertext,name="§eTeam 15",r=1] ~ ~ ~ tag @p add joinprocessteam15
execute @a[tag=!team,tag=!joinprocessteam16,scores={teamspaceleft=1..}] ~ ~ ~ execute @e[type=hovertext:hovertext,name="§eTeam 16",r=1] ~ ~ ~ tag @p add joinprocessteam16
execute @a[tag=!team,tag=!joinprocessteam17,scores={teamspaceleft=1..}] ~ ~ ~ execute @e[type=hovertext:hovertext,name="§eTeam 17",r=1] ~ ~ ~ tag @p add joinprocessteam17
execute @a[tag=!team,tag=!joinprocessteam18,scores={teamspaceleft=1..}] ~ ~ ~ execute @e[type=hovertext:hovertext,name="§eTeam 18",r=1] ~ ~ ~ tag @p add joinprocessteam18
execute @a[tag=!team,tag=!joinprocessteam19,scores={teamspaceleft=1..}] ~ ~ ~ execute @e[type=hovertext:hovertext,name="§eTeam 19",r=1] ~ ~ ~ tag @p add joinprocessteam19
execute @a[tag=!team,tag=!joinprocessteam20,scores={teamspaceleft=1..}] ~ ~ ~ execute @e[type=hovertext:hovertext,name="§eTeam 20",r=1] ~ ~ ~ tag @p add joinprocessteam20
execute @a[tag=!team,tag=!joinprocessteam21,scores={teamspaceleft=1..}] ~ ~ ~ execute @e[type=hovertext:hovertext,name="§eTeam 21",r=1] ~ ~ ~ tag @p add joinprocessteam21
execute @a[tag=!team,tag=!joinprocessteam12,scores={teamspaceleft=1..}] ~ ~ ~ execute @e[type=hovertext:hovertext,name="§eTeam 22",r=1] ~ ~ ~ tag @p add joinprocessteam22
execute @a[tag=!team,tag=!joinprocessteam23,scores={teamspaceleft=1..}] ~ ~ ~ execute @e[type=hovertext:hovertext,name="§eTeam 23",r=1] ~ ~ ~ tag @p add joinprocessteam23
execute @a[tag=!team,tag=!joinprocessteam24,scores={teamspaceleft=1..}] ~ ~ ~ execute @e[type=hovertext:hovertext,name="§eTeam 24",r=1] ~ ~ ~ tag @p add joinprocessteam24
execute @a[tag=!team,tag=!joinprocessteam25,scores={teamspaceleft=1..}] ~ ~ ~ execute @e[type=hovertext:hovertext,name="§eTeam 25",r=1] ~ ~ ~ tag @p add joinprocessteam25
...
execute @a[tag=!team,tag=joinprocessteam14,scores={teamspaceleft=1..}] ~ ~ ~ function code/english/chooseteam/join/14
execute @a[tag=!team,tag=joinprocessteam15,scores={teamspaceleft=1..}] ~ ~ ~ function code/english/chooseteam/join/15
execute @a[tag=!team,tag=joinprocessteam16,scores={teamspaceleft=1..}] ~ ~ ~ function code/english/chooseteam/join/16
execute @a[tag=!team,tag=joinprocessteam17,scores={teamspaceleft=1..}] ~ ~ ~ function code/english/chooseteam/join/17
execute @a[tag=!team,tag=joinprocessteam18,scores={teamspaceleft=1..}] ~ ~ ~ function code/english/chooseteam/join/18
execute @a[tag=!team,tag=joinprocessteam19,scores={teamspaceleft=1..}] ~ ~ ~ function code/english/chooseteam/join/19
execute @a[tag=!team,tag=joinprocessteam20,scores={teamspaceleft=1..}] ~ ~ ~ function code/english/chooseteam/join/20
execute @a[tag=!team,tag=joinprocessteam21,scores={teamspaceleft=1..}] ~ ~ ~ function code/english/chooseteam/join/21
execute @a[tag=!team,tag=joinprocessteam22,scores={teamspaceleft=1..}] ~ ~ ~ function code/english/chooseteam/join/22
execute @a[tag=!team,tag=joinprocessteam23,scores={teamspaceleft=1..}] ~ ~ ~ function code/english/chooseteam/join/23
execute @a[tag=!team,tag=joinprocessteam24,scores={teamspaceleft=1..}] ~ ~ ~ function code/english/chooseteam/join/24
execute @a[tag=!team,tag=joinprocessteam25,scores={teamspaceleft=1..}] ~ ~ ~ function code/english/chooseteam/join/25
#voll
