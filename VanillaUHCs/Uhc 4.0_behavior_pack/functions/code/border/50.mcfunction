...
#seiten
execute @s[x=51,y=~,z=~,dx=960] ~ ~ ~ function code/border/tp/50/s1
execute @s[x=-51,y=~,z=~,dx=-960] ~ ~ ~ function code/border/tp/50/s2
execute @s[x=~,y=~,z=51,dz=960] ~ ~ ~ function code/border/tp/50/s3
execute @s[x=~,y=~,z=-51,dz=-960] ~ ~ ~ function code/border/tp/50/s4
#safety
