tellraw @a {"rawtext":[{"text":"§6§lVanillaUHCs"}]}
execute @s[tag=mainhost,scores={ranked=2}] ~ ~ ~ tellraw @a {"rawtext":[{"text":"§c§lTournament"}]}
...
execute @s[tag=mainhost,scores={config=1}] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"config1.5"}]}
execute @s[tag=mainhost,scores={config=1}] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"config1.6"}]}
execute @s[tag=mainhost,scores={config=1}] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"config1.7"}]}
...
execute @s[tag=mainhost,scores={config=2}] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"config2.5"}]}
execute @s[tag=mainhost,scores={config=2}] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"config2.6"}]}
execute @s[tag=mainhost,scores={config=2}] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"config2.7"}]}
execute @s[tag=mainhost,scores={config=2}] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"config2.8"}]}
...
execute @s[tag=mainhost,scores={config=3}] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"config3.5"}]}
execute @s[tag=mainhost,scores={config=3}] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"config3.6"}]}
execute @s[tag=mainhost,scores={config=3}] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"config3.7"}]}
...
execute @s[tag=mainhost,scores={config=4}] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"config4.5"}]}
execute @s[tag=mainhost,scores={config=4}] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"config4.6"}]}
execute @s[tag=mainhost,scores={config=4}] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"config4.7"}]}
execute @s[tag=mainhost,scores={config=4}] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"config4.8"}]}
execute @s[tag=mainhost,scores={config=4}] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"config4.9"}]}
#szenarien
tellraw @a {"rawtext":[{"text":"-------------------"}]}
tellraw @a {"rawtext":[{"translate":"config.scenarios"}]}
tellraw @a {"rawtext":[{"text":"§eCutClean"}]}
execute @s[tag=mainhost,scores={vanilla=1}] ~ ~ ~ tellraw @a {"rawtext":[{"text":"§eVanilla+"}]}
execute @s[tag=mainhost,scores={hasteyboys=1}] ~ ~ ~ tellraw @a {"rawtext":[{"text":"§eHasteyboys"}]}
execute @s[tag=mainhost,scores={peaceful=1}] ~ ~ ~ tellraw @a {"rawtext":[{"text":"§ePeaceful"}]}
execute @s[tag=mainhost,scores={nofall=1}] ~ ~ ~ tellraw @a {"rawtext":[{"text":"§eNoFall"}]}
execute @s[tag=mainhost,scores={noclean=1}] ~ ~ ~ tellraw @a {"rawtext":[{"text":"§eNoClean"}]}
execute @s[tag=mainhost,scores={enchantless=1}] ~ ~ ~ tellraw @a {"rawtext":[{"text":"§eEnchantless"}]}
execute @s[tag=mainhost,scores={fireless=1}] ~ ~ ~ tellraw @a {"rawtext":[{"text":"§eFireless"}]}
execute @s[tag=mainhost,scores={timebomb=1}] ~ ~ ~ tellraw @a {"rawtext":[{"text":"§eTimebomb"}]}
execute @s[tag=mainhost,scores={diamondless=1}] ~ ~ ~ tellraw @a {"rawtext":[{"text":"§eDiamondless"}]}
execute @s[tag=mainhost,scores={bowless=1}] ~ ~ ~ tellraw @a {"rawtext":[{"text":"§eBowless"}]}
execute @s[tag=mainhost,scores={shields=1}] ~ ~ ~ tellraw @a {"rawtext":[{"text":"§eShields"}]}
execute @s[tag=mainhost,scores={rodless=1}] ~ ~ ~ tellraw @a {"rawtext":[{"text":"§eRodless"}]}
execute @s[tag=mainhost,scores={limitations=1}] ~ ~ ~ tellraw @a {"rawtext":[{"text":"§eLimitations"}]}
execute @s[tag=mainhost,scores={blooddiamonds=1}] ~ ~ ~ tellraw @a {"rawtext":[{"text":"§eBlooddiamonds"}]}
execute @s[tag=mainhost,scores={doubleores=1}] ~ ~ ~ tellraw @a {"rawtext":[{"text":"§eDoubleores"}]}
#other stuff
tellraw @a {"rawtext":[{"text":"-------------------"}]}
tellraw @a {"rawtext":[{"translate":"config.settings"}]}
execute @s[tag=mainhost,scores={nether=0}] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"config.nether.off"}]}
execute @s[tag=mainhost,scores={nether=1}] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"config.nether.on"}]}
execute @s[tag=mainhost,scores={strength=0}] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"config.strength.off"}]}
execute @s[tag=mainhost,scores={strength=1}] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"config.strength.on"}]}
execute @s[tag=mainhost,scores={invisibility=0}] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"config.invisibility.off"}]}
execute @s[tag=mainhost,scores={invisibility=1}] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"config.invisibility.on"}]}
execute @s[tag=mainhost,scores={ipvp=0}] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"config.ipvp.off"}]}
execute @s[tag=mainhost,scores={ipvp=1}] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"config.ipvp.on"}]}
execute @s[tag=mainhost,scores={stalking=0}] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"config.stalking.off"}]}
execute @s[tag=mainhost,scores={stalking=1}] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"config.stalking.on"}]}
execute @s[tag=mainhost,scores={notchapples=0}] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"config.notchapples.off"}]}
execute @s[tag=mainhost,scores={notchapples=1}] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"config.notchapples.on"}]}
