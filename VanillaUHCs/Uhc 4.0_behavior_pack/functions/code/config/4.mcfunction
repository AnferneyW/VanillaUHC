...
#borderannouncements
execute @s[scores={timer=2400}] ~ ~ ~ scoreboard players reset "§eBorder: §f1000" uhc
execute @s[scores={timer=2400}] ~ ~ ~ scoreboard players set "§eBorder: §f750" uhc -1
...
execute @s[scores={timer=2400,border=1}] ~ ~ ~ scoreboard players set @p border 2
